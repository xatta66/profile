    ...
    <div className="About" ref={ref} >    
        <div >
            ...
            <div className="textAboutMe">
                <p>Всем привет! Меня зовут Алексей, я начинающий Frontend-разработчик и Вы находитесь на моей страничке-портфолио, 
                   где можете ознакомиться с моими предыдущими работами.
                   Так же здесь находится информация обо мне, моих навыках и опыте.</p>
